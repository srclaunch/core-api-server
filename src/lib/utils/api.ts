 ...
 */
export const ApiResponseStatusCodeRetryMap: { [key in ApiResponseStatusCode]: ApiResponseCodeDetails } = {
  /**
   * __100 - Continue__
   ...
   */
  [ApiResponseStatusCode.CONTINUE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.SWITCHING_PROTOCOLS]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PROCESSING]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   * */
  [ApiResponseStatusCode.ACCEPTED]: {
    failure: false,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.NON_AUTHORITATIVE_INFORMATION]: {
    failure: false,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.RESET_CONTENT]: {
    failure: false,
    retryable: false,
  },
   ...
   */
  [ApiResponseStatusCode.PARTIAL_CONTENT]: {
    failure: false,
    retryable: false,
  },
   ...
   */
  [ApiResponseStatusCode.MULTI_STATUS]: {
    failure: false,
    retryable: false,
  },
   ...
   */
  [ApiResponseStatusCode.ALREADY_REPORTED]: {
    failure: false,
    retryable: false,
  },
   ...
   */
  [ApiResponseStatusCode.MULTIPLE_CHOICES]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.MOVED_PERMANENTLY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.SEE_OTHER]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.NOT_MODIFIED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.USE_PROXY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.SWITCH_PROXY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.TEMPORARY_REDIRECT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PERMANENT_REDIRECT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PAYMENT_REQUIRED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.NOT_ACCEPTABLE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PROXY_AUTHENTICATION_REQUIRED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   * "The client did not produce a request within the time that the server was prepared to wait. The client MAY repeat the request without modifications at any later time."
   */
  [ApiResponseStatusCode.REQUEST_TIMEOUT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.CONFLICT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.LENGTH_REQUIRED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PRECONDITION_FAILED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PAYLOAD_TOO_LARGE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.URI_TOO_LONG]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.UNSUPPORTED_MEDIA_TYPE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.RANGE_NOT_SATISFIABLE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.EXPECTATION_FAILED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.I_AM_A_TEAPOT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.MISDIRECTED_REQUEST]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.UNPROCESSABLE_ENTITY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.FAILED_DEPENDENCY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.TOO_EARLY]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.UPGRADE_REQUIRED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.PRECONDITION_REQUIRED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.TOO_MANY_REQUESTS]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.REQUEST_HEADER_FIELDS_TOO_LARGE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.UNAVAILABLE_FOR_LEGAL_REASONS]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.GATEWAY_TIMEOUT]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.HTTP_VERSION_NOT_SUPPORTED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.VARIANT_ALSO_NEGOTIATES]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.INSUFFICIENT_STORAGE]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.LOOP_DETECTED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.BANDWIDTH_LIMIT_EXCEEDED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.NOT_EXTENDED]: {
    failure: true,
    retryable: false,
  },
  /**
   ...
   */
  [ApiResponseStatusCode.NETWORK_AUTHENTICATION_REQUIRED]: {
    failure: true,
    retryable: false,
  },
};
